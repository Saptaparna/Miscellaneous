...
int ReadHGCTiming_Tree_Jun3(std::string infile, std::string outfile)
{
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    for (unsigned int j=0; j<recHit_energy->size(); j++)
    {
      ...
      {  
        recHit.recHitTime = recHit_time->at(j) + ((10.9798-10.8251)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 1 and window 2
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((11.136-10.9798)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 2 and window 3
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((11.2856-11.136)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 3 and window 4
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((11.4432-11.2856)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 4 and window 5
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((11.6065-11.4432)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 5 and window 6
      ...
      {  
        recHit.recHitTime = recHit_time->at(j) + ((11.7761-11.6065)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 6 and window 7
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((11.9335-11.7761)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 7 and window 8
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((12.098-11.9335)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 8 and window 9
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((12.2761-12.098)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 9 and window 10
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((12.392-12.2761)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 10 and window 11
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((12.5858-12.392)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 11 and window 12
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((13.5699-12.5858)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 12 and window 13
      ...
      {
        recHit.recHitTime = recHit_time->at(j) + ((13.591-13.5699)/(speedOfLight)) - 1.0 + 10.8251; //difference of time between window 13 and window 14
