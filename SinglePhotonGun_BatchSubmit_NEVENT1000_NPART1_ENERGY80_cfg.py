...
#random number seed
process.RandomNumberGeneratorService.generator.initialSeed = cms.untracked.uint32(1000+1)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('SinglePhotonPt80_cfi nevts:1000'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SinglePhotonGunPt80_n1000_part1.root'),
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer",
    ...
    psethack = cms.string('single photon pt 80'),
