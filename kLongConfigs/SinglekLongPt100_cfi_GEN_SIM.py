...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('SinglekLongPt100_cfi nevts:100'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_kLong_Pt100.root'),
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer",
    ...
    PGunParameters = cms.PSet(
        ...
        MaxPt = cms.double(99.99),
        MinEta = cms.double(-5.0),
        MinPhi = cms.double(-3.14159265359),
        MinPt = cms.double(100.01),
        PartID = cms.vint32(130)
    ),
    Verbosity = cms.untracked.int32(0),
    firstRun = cms.untracked.uint32(1),
    psethack = cms.string('single kLong pt 100')
)
