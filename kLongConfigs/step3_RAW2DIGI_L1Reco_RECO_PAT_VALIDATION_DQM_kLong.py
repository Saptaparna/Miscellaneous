...
# with command line options: step3 --conditions auto:run2_mc -n 10 --era Phase2C2_timing --eventcontent FEVTDEBUGHLT,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,PAT,VALIDATION:@phase2Validation+@miniAODValidation,DQM:@phase2+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023tilted --geometry Extended2023D3 --no_exec --filein file:step2.root --fileout file:step3.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step2_kLong_Pt100.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_kLong_Pt100.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_inMINIAODSIM_kLong_Pt100.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_inDQM_kLong_Pt100.root'),
...
process.prevalidation_step5 = cms.Path(process.prevalidationMiniAOD)
...
process.validation_step5 = cms.EndPath(process.validationMiniAOD)
