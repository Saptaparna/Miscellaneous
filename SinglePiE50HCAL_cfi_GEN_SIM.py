...
# with command line options: SinglePiE50HCAL_cfi --conditions auto:run2_mc -n 10 --era Phase2C2_timing --eventcontent FEVTDEBUG --relval 10000,100 -s GEN,SIM --datatier GEN-SIM --beamspot Realistic50ns13TeVCollision --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023tilted --geometry Extended2023D3 --no_exec --fileout file:step1.root
