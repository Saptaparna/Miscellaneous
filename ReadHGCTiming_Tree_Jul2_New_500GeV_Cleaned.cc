...
int ReadHGCTiming_Tree_Jun3(std::string infile, std::string outfile)
{
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    if(not (fraction >= 0.15 and fraction <= 0.70)) continue;
    if(not (sumOfHitEnergy80Percent > 3.4 and sumOfHitEnergy80Percent <= 9.4)) continue;

    for (int j=0; j<hitNumber; j++)
    {
      if(sameVal(recHits.at(j).recHitE, 0.225)) continue;
      ...
      {  
        double recHitTimeWindow1 = recHits.at(j).recHitTime + ((10.9784-10.8335)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 1 and window 2
      ...
      {
        double recHitTimeWindow2 = recHits.at(j).recHitTime + ((11.1278-10.9784)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 2 and window 3
      ...
      {
        double recHitTimeWindow3 = recHits.at(j).recHitTime + ((11.3025-11.1278)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 3 and window 4
      ...
      {
        double recHitTimeWindow4 = recHits.at(j).recHitTime + ((11.4645-11.3025)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 4 and window 5
      ...
      {
        double recHitTimeWindow5 = recHits.at(j).recHitTime + ((11.6201-11.4645)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 5 and window 6
      ...
      {  
        double recHitTimeWindow6 = recHits.at(j).recHitTime + ((11.7711-11.6201)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 6 and window 7
      ...
      {
        double recHitTimeWindow7 = recHits.at(j).recHitTime + ((11.9373-11.7711)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 7 and window 8
      ...
      {
        double recHitTimeWindow8 = recHits.at(j).recHitTime + ((12.1072-11.9373)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 8 and window 9
      ...
      {
        double recHitTimeWindow9 = recHits.at(j).recHitTime + ((12.2807-12.1072)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 9 and window 10
      ...
      {
        double recHitTimeWindow10 = recHits.at(j).recHitTime + ((12.4312-12.2807)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 10 and window 11
      ...
      {
        double recHitTimeWindow11 = recHits.at(j).recHitTime + ((12.6056-12.4312)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 11 and window 12
      ...
      {
        double recHitTimeWindow12 = recHits.at(j).recHitTime + ((12.8135-12.6056)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 12 and window 13
      ...
      {
        double recHitTimeWindow13 = recHits.at(j).recHitTime + ((13.0518-12.8135)/(speedOfLight)) - 1.0 + 10.8335; //difference of time between window 13 and window 14
