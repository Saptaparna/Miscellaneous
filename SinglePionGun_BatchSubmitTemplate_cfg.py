...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('SinglePionPtENERGY_cfi nevts:NEVENT'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SinglePionGunPtENERGY_nNEVENT_partNPART.root'),
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer",
    ...
    psethack = cms.string('single pion pt ENERGY'),
