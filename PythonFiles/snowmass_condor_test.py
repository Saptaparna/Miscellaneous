...
#       names are up to you
miscFiles = {}
miscFiles['jec_uncertainty']   = 'Summer12_V2_DATA_AK5PF_UncertaintySources.txt'
miscFiles['btag_performance']  = 'btag_performance_db062012.root'
miscFiles['json']              = 'Cert_190456-208686_8TeV_PromptReco_Collisions12_JSON.txt'
miscFiles['MCL1JetPar']        = 'START53_V7G_L1FastJet_AK5PFchs.txt'
miscFiles['MCL2JetPar']        = 'START53_V7G_L2Relative_AK5PFchs.txt'
miscFiles['MCL3JetPar']        = 'START53_V7G_L3Absolute_AK5PFchs.txt'
miscFiles['DataL1JetPar']      = 'FT_53_V10_AN3_L1FastJet_AK5PFchs.txt'
miscFiles['DataL2JetPar']      = 'FT_53_V10_AN3_L2Relative_AK5PFchs.txt'
miscFiles['DataL3JetPar']      = 'FT_53_V10_AN3_L3Absolute_AK5PFchs.txt'
miscFiles['DataResJetPar']     = 'FT_53_V10_AN3_L2L3Residual_AK5PFchs.txt'
...
process.outputs = cms.PSet (
    outputName = cms.string('TTbar_1_0000'),
...
process.inputs = cms.PSet (
    nEvents    = cms.int32(30000000),
    skipEvents = cms.int32(0),
    lumisToProcess = CfgTypes.untracked(CfgTypes.VLuminosityBlockRange()),
    fileNames  = cms.vstring()
    )
    
#process.inputs.fileNames.extend(['dcap://cmsgridftp.fnal.gov:24125/pnfs/fnal.gov/usr/cms/WAX/11/store/user/snowmass/Delphes-3.0.6.1/NoPileUp/TTBAR_13TEV/0001/TTBAR_13TEV_NoPileUp_15566.root'])
#process.inputs.fileNames.extend(['dcap://cmsgridftp.fnal.gov:24125/pnfs/fnal.gov/usr/cms/WAX/11/store/user/snowmass/Delphes-3.0.6.1/NoPileUp/TTBAR_13TEV/0001/TTBAR_13TEV_NoPileUp_146489467.root'])

#process.inputs.fileNames.extend(['/eos/uscms/store/user/jstupak/snowmass/14TeV/HWW_14TEV_1000_NoPileUp.root'])

#process.inputs.fileNames.extend(['dcap://cmsgridftp.fnal.gov:24125/pnfs/fnal.gov/usr/cms/WAX/11/store/user/snowmass/Delphes-3.0.6.1/NoPileUp/TTBAR_13TEV/TTBAR_13TEV_NoPileUp_287502962.root'])

process.inputs.fileNames.extend(['dcap://cmsgridftp.fnal.gov:24125/pnfs/fnal.gov/usr/cms/WAX/11/store/user/snowmass/Delphes-3.0.6.1/NoPileUp/TTBAR_13TEV/0001/TTBAR_13TEV_NoPileUp_16432.root'])
