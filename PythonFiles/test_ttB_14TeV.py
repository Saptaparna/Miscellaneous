...
for sigma,hist in zip(sigmas,histnames):
    #print bin
    #f=TFile(file)
    #t=f.Get("Delphes")
    ...
    #file = files.readline()
    #print file
    #files='root://eoscms.cern.ch//eos/cms/store/group/phys_higgs/upgrade/PhaseII/Configuration4v2/140PileUp/ttB-4p-0-900-v1510_14TEV/ttB-4p-0-900-v1510_14TEV_97512976_PhaseII_Conf4v2_140PileUp.root'
