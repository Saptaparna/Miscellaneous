...
int ReadHGCTiming_Tree_Jun3(std::string infile, std::string outfile)
{
  ...
  for (int i=0; i<nEvents; ++i)
  {
    ...
    for (int j=0; j<hitNumber; j++)
    {
      ...
      {  
        double recHitTimeWindow1 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 1 and window 2
      ...
      {
        double recHitTimeWindow2 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 2 and window 3
      ...
      {
        double recHitTimeWindow3 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 3 and window 4
      ...
      {
        double recHitTimeWindow4 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 4 and window 5
      ...
      {
        double recHitTimeWindow5 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 5 and window 6
      ...
      {  
        double recHitTimeWindow6 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 6 and window 7
      ...
      {
        double recHitTimeWindow7 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 7 and window 8
      ...
      {
        double recHitTimeWindow8 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 8 and window 9
      ...
      {
        double recHitTimeWindow9 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 9 and window 10
      ...
      {
        double recHitTimeWindow10 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 10 and window 11
      ...
      {
        double recHitTimeWindow11 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 11 and window 12
      ...
      {
        double recHitTimeWindow12 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 12 and window 13
      ...
      {
        double recHitTimeWindow13 = recHits.at(j).recHitTime + ((pathDifference)/(speedOfLight)) - 1.0; //difference of time between window 13 and window 14
